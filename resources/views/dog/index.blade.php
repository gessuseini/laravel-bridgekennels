<x-app-layout>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="readmore_bt center margin_top_20 grid grid-cols-3 gap-4">
                        <a id="allDogsBtn" class="main_bt filter-dogs bg-gray-700 hover:bg-blue-500 text-gray-700 hover:text-white mr-3 active" href="#" data-gender="all">All Dogs</a>
                        <a id="maleDogsBtn" class="main_bt filter-dogs bg-gray-700 hover:bg-blue-500 text-gray-700 hover:text-white mr-3" href="#" data-gender="male">Male Dogs</a>
                        <a id="femaleDogsBtn" class="main_bt read_more_bt filter-dogs bg-gray-700 hover:bg-blue-500 text-gray-700 hover:text-white" href="#" data-gender="female">Female Dogs</a>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.filter-dogs').click(function(e) {
                var gender = $(this).data('gender');
                e.preventDefault();

                // Add active class and disable the button
                $(this).addClass("active");
                $('.filter-dogs').not(this).removeClass("active");
