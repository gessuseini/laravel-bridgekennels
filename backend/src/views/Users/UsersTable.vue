            ...
            <CardHeader>
                ...
                <div class="flex justify-between">
                    <div class="flex items-center">
                        ...
                        <select @change="getUsers(null)" v-model="perPage" class="appearance-none relative block w-8 md:w-14 lg:w-16 px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-primary focus:z-10 sm:text-sm">
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead class="hidden md:table-cell">Admin Permission</TableHead>
                    ...
                    <TableBody>
                        <TableRow v-for="(user, index) of users.data" class="animate-fade-in-down" :style="{'animation-delay': `${index * 0.05}s`}">
                            <TableCell>
                                {{ user.id }}
                            </TableCell>
                            ...
                            <TableCell>
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end">
                                        ...
                                        <DropdownMenuItem @click="deleteUser(user)">Delete</DropdownMenuItem>
                                    </DropdownMenuContent>
                                </DropdownMenu>
                            </TableCell>
                        </TableRow>
