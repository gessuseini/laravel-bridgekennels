                        ...
                        <DialogPanel
                            ...
                            <header class="py-3 px-4 flex justify-between items-center">
                                <DialogTitle as="h3" class="text-lg leading-6 font-medium text-gray-900">
                                    {{ faq.id ? `Edit: ${props.faq.question}` : 'Add new FAQ' }}
                                </DialogTitle>
                                <button
                                    @click="closeModal"
                            ...
                            <form @submit.prevent="onSubmit">
                                <div v-if="!loading" class="bg-white px-4 pt-5 pb-4">
                                    <CustomInput class="mb-2" v-model="faq.question" label="Question"/>
                                    <CustomInput class="mb-2" v-model="faq.answer" label="Answer"/>
                                </div>
...
function onSubmit() {
    loading.value = true
    if (faq.value.id) {
        store.dispatch('updateFAQ', faq.value)
            .then(response => {
                loading.value = false;
        ...
        store.dispatch('createFAQ', faq.value)
            .then(response => {
                loading.value = false;
